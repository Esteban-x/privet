  ...
  return (
    <section className="rounded-[20px] surface p-6">
      ...
      <button
        ...
        disabled={pending}
        className="mt-4 rounded-[10px] border border-border px-5 py-2.5 font-display text-sm font-semibold text-text transition-colors hover:bg-accent/10 hover:border-accent/35 disabled:opacity-60"
      >
