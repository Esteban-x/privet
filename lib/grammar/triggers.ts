...
export const TRIGGERS: CaseTrigger[] = [
  ...
  },
  {
    ...
    article: "demonstrative",
    ru: "искать",
    meaningFr: "Complément d'objet direct (objet concret).",
    template: { ru: "Я ищу ___.", fr: "Je cherche ___." },
  },
  {
    id: "verb-acc-zhdat",
    caseId: "accusative",
    ...
    article: "demonstrative",
    ru: "ждать",
    meaningFr: "Complément d'objet direct (objet concret/défini).",
    template: { ru: "Я жду ___.", fr: "J'attends ___." },
  },
  {
