...
const ACTIVE_CONTEXTS: ActiveContext[] = [
  ...
  },
  {
    ...
    verb: "pisat",
    tense: "present",
    expanded: "Девушка, которая пишет письмо, — журналистка.",
    compressed: "Девушка, ___ письмо, — журналистка.",
  ...
  },
  {
    ...
    verb: "stroit",
    tense: "past",
    expanded: "Инженер, который строил этот мост, уже на пенсии.",
    compressed: "Инженер, ___ этот мост, уже на пенсии.",
  ...
  },
  {
    ...
    verb: "pomogat",
    tense: "present",
    expanded: "Друзья, которые помогают нам, живут рядом.",
    compressed: "Друзья, ___ нам, живут рядом.",
    fr: "Les amis qui nous aident habitent à côté.",
    why: "Le participe s'accorde au pluriel avec « друзья », comme le ferait un adjectif.",
  },
  {
    id: "woman-returning",
    verb: "vozvrashchatsya",
    tense: "present",
    expanded: "Женщина, которая возвращается домой, работает в больнице.",
    compressed: "Женщина, ___ домой, работает в больнице.",
...
const SHORT_CONTEXTS: ShortContext[] = [
  ...
  },
  {
    ...
    form: "short",
    agreement: "n",
    sentence: "Письмо ___ по-русски.",
    fr: "La lettre est écrite en russe.",
    why: "Attribut du sujet « письмо », neutre : forme courte accordée au neutre.",
  },
  {
    id: "written-letter",
    verb: "pisat",
    form: "long",
    agreement: "n",
    sentence: "Он показал мне ___ письмо.",
    fr: "Il m'a montré la lettre écrite.",
    why: "Épithète : le participe qualifie « письмо » à l'intérieur du groupe nominal → forme longue.",
  },
  {
  ...
  },
  {
    ...
    form: "long",
    agreement: "m",
    sentence: "Мы обсудили ___ ответ.",
    fr: "Nous avons discuté de la réponse reçue.",
    why: "Épithète devant le nom : forme longue, accordée au masculin avec « ответ ».",
  },
];
...
const GERUND_CONTEXTS: GerundContext[] = [
  ...
  },
  {
    ...
    verb: "otkryvat",
    aspect: "perfective",
    expanded: "Когда она открыла окно, она услышала музыку.",
    compressed: "___ окно, она услышала музыку.",
  ...
  },
  {
    ...
    verb: "izuchat",
    aspect: "imperfective",
    expanded: "Пока он изучал русский язык, он вёл записи.",
    compressed: "___ русский язык, он вёл записи.",
  ...
  },
  {
    ...
    verb: "gotovit",
    aspect: "imperfective",
    expanded: "Пока она готовила ужин, она слушала радио.",
    compressed: "___ ужин, она слушала радио.",
    fr: "En préparant le dîner, elle écoutait la radio.",
    why: "Deux occupations menées de front → gérondif imperfectif. Le radical alterne : готовить → готовя.",
  },
  {
    id: "arrived-called",
    verb: "idti",
    aspect: "perfective",
    expanded: "Когда он пришёл домой, он сразу позвонил матери.",
    compressed: "___ домой, он сразу позвонил матери.",
    fr: "Une fois rentré, il a tout de suite appelé sa mère.",
    why: "Gérondif perfectif irrégulier : придя, et non « пришедши » — forme à mémoriser.",
  },
];
